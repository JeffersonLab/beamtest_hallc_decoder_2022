...
** clone this git and "cd beamtest_hallc_decoder"
** echo $SHELL (run tcsh it's not your default shell, disable your .cshrc and .login if any conflict with your default env)
